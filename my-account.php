	...
	if(strlen($_SESSION['login'])==0) {   
		...
		if(isset($_POST['submit'])) {
			...
			if($num>0) {
				...
				echo "<script>alert('Senha atual não corresponde!');</script>";
			}
		}
?>
<!DOCTYPE html>
		...
		<script type="text/javascript">
			function valid() {
				if(document.chngpwd.cpass.value=="") {
					alert("Senha atual está vazia!");
					document.chngpwd.cpass.focus();
					return false;
				} else if(document.chngpwd.newpass.value=="") {
					alert("Nova Senha está vazia!");
					document.chngpwd.newpass.focus();
					return false;
				} else if(document.chngpwd.cnfpass.value=="") {
					alert("Confirmar Nova Senha está vazia!");
						    		...
						    		<div id="collapseTwo" class="panel-collapse collapse">
						      			<div class="panel-body">
						    				<form class="register-form" role="form" method="post" name="chngpwd" onSubmit="return valid();">
												<div class="form-group">
													<label class="info-title" for="Current Password">Senha Atual <span>*</span></label>
												...
												<div class="form-group">
													<label class="info-title" for="Confirm Password">Confrimar Nova Senha <span>*</span></label>
													<input type="password" class="form-control unicase-form-control text-input" id="cnfpass" name="cnfpass" required="required" >
												</div>
												<button type="submit" name="submit" class="btn-upper btn btn-primary checkout-page-button">Alterar</button>
											</form> 
						      			</div>
						    		</div>
					  			</div>
