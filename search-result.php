...
<!-- ============================================== COLOR: END ============================================== -->
	...
	<div id="category" class="category-carousel hidden-xs">
		<div class="item">	
			<div class="image">
				<img src="assets/images/banners/teste1.png" alt="" class="img-responsive">
			</div>
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				<span class="price">
					...
					<!-- Sistema de desconto --><span class="price-before-discount">R$ <?php echo htmlentities($row['productPriceBeforeDiscount']);?></span>
