...
function getBannerPath($subcategoryId) {
    // Define a extensão da imagem (neste exemplo, .png)
    $imageExtension = '.png';
    // Define o caminho base para a pasta de banners
    $basePath = 'assets/images/banners2/';
    // Caminho completo do banner usando o ID da categoria
    $bannerPath = $basePath . $subcategoryId . $imageExtension;
    return $bannerPath;
}
...
<html lang="pt-br">
	<head>
	    ...
	    <title>Subcategoria do Produto</title>
...
<!-- ============================================== COLOR: END ============================================== -->
	...
	<div id="category" class="category-carousel hidden-xs">
		...
		<div class="image">
                                <?php
                                // Obtém o caminho do banner com base no ID da categoria
                                $bannerPath = getBannerPath($cid);
                                ?>
                                <img src="<?php echo $bannerPath; ?>" alt="" class="img-responsive">
                            </div>
				...
				<div class="action">
					...
					<?php } ?>
		                ...
		                <li class="lnk wishlist">
							<a class="add-to-cart" href="category.php?pid=<?php echo htmlentities($row['id'])?>&&action=wishlist" title="Lista de Desejos">
