	...
	if(isset($_SESSION['cart'][$id])){
		...
		if(mysqli_num_rows($query_p)!=0){
			...
			$_SESSION['cart'][$row_p['id']]=array("quantity" => 1, "price" => $row_p['productPrice']);
					echo "<script>alert('Produto adicionado ao seu carrinho')</script>";
		echo "<script type='text/javascript'> document.location ='my-cart.php'; </script>";
		}else{
			$message="ID do produto inválida";
		}
	}
}
$pid=intval($_GET['pid']);
...
echo "<script>alert('Produto adicionado na lista de desejos');</script>";
						...
						<div class="product-info">
							...
							<div class="stock-container info-container m-t-10">
								<div class="row">
									<div class="col-sm-3">
										<div class="stock-box">
											<span class="label">Avaliabilidade :</span>
										</div>	
									</div>
									<div class="col-sm-9">
										<div class="stock-box">
								...
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="favorite-button m-t-10">
											<a class="btn btn-primary" data-toggle="tooltip" data-placement="right" title="Lista de Desejos" href="product-details.php?pid=<?php echo htmlentities($row['id'])?>&&action=wishlist">
...
<?php if($row['productAvailability']=='Em estoque'){?>
										<a href="product-details.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="btn btn-danger"><i class="fa fa-shopping-cart inner-right-vs"></i> Adicionar ao Carrinho</a>
													<?php } else {?>
							<div class="action" style="color:red">Sem Estoque</div>
					<?php } ?>
									</div>
			...
			<div class="product-price">	
				...
				<div class="action">
					<ul class="list-unstyled">
						...
						<a href="product-details.php?page=product&action=add&id=<?php echo $rw['id']; ?>" class="lnk btn btn-primary">Adicionar ao carrinho</a>
