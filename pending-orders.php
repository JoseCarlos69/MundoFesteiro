									...
									<table class="table table-bordered">
										<thead>
											<tr>
												...
												<th class="cart-sub-total item">Preço do Envio</th>
												<th class="cart-total">Total de Itens</th>
												<th class="cart-total item">Método de pagamento</th>
												<th class="cart-description item">Data do Pedido</th>
												<th class="cart-total last-item">Deletar</th>
											</tr>
										</thead>
										<tbody>
											...
											<tr>
												...
												<td class="cart-image">
													<a class="entry-thumbnail" href="product-details.php?pid=<?php echo htmlentities($pd=$row['id']);?>">
														<img src="admin/productimages/<?php echo $row['opid'];?>/<?php echo $row['pimg1'];?>" alt="" width="150" height="150	">
													</a>
												</td>
												...
												<td class="cart-product-sub-total">
													R$ <?php echo $price=$row['pprice']; ?>.00 
												</td>
												<td class="cart-product-sub-total">
													R$ <?php echo $shippcharge=$row['shippingcharge']; ?>.00
												</td>
												<td class="cart-product-grand-total">
													R$ <?php echo (($qty*$price)+$shippcharge);?>.00
												</td>
												<td class="cart-product-sub-total">
													<?php echo $row['paym']; ?>  
												</td>
												...
												<td>
													<a href="pending-orders.php?id=<?php echo $row['oid']; ?> ">Deletar
												</td>
											</tr>
											<?php $cnt=$cnt+1;} ?>
											<tr>
												<td colspan="9">
													<div class="cart-checkout-btn pull-right" >
														<button type="submit" name="ordersubmit" class="btn btn-primary">
															<a href="payment-method.php" style="color: white;">Prosseguir para pagamento</a>
														</button>
													</div>
												</td>
											</tr>
