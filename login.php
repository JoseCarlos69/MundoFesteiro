...
if($query)
{
	echo "<script>alert('Você está cadastrado com sucesso');</script>";
}
else{
echo "<script>alert('Cadastro não concluído');</script>";
}
}
// Code for User login
...
<html lang="pt-br">
	<head>
	    ...
	    <title>Mundo Festeiro - Cadastro e Login</title>
...
{
alert("Senha e senha de confirmação não correspondem!!");
	...
	<div class="container">
		<div class="breadcrumb-inner">
			<ul class="list-inline list-unstyled">
				...
				<li class='active'>Login e Cadastro</li>
			</ul>
...
<div class="col-md-6 col-sm-6 sign-in">
	<h4 class="">Logar</h4>
	<p class="">Bem-vindo, entre com sua conta abaixo</p>
...
?>
		...
		<div class="radio outer-xs">
	  	...
	  	<button type="submit" class="btn-upper btn btn-primary checkout-page-button" name="login">Logar</button>
	</form>					
</div>
<!-- Sign-in -->
...
<div class="col-md-6 col-sm-6 create-new-account">
	...
	<p class="text title-tag-line">Crie sua conta para poder comprar no site</p>
...
<div class="form-group">
	...
	<span class="checkout-subtitle outer-top-xs">Com uma conta você pode: </span>
	<div class="checkbox">
	  	<label class="checkbox">
		  	Facilitar na hora de finalizar a compra.
		</label>
		<label class="checkbox">
		Rastrear seus pedidos.
		</label>
		<label class="checkbox">
		Ter um histórico dos seus pedidos.
		</label>
	</div>
</div>	
