...
{
alert("Senha de Confirmação está vazia!!");
document.chngpwd.confirmpassword.focus();
return false;
}
else if(document.chngpwd.newpassword.value!= document.chngpwd.confirmpassword.value)
{
alert("Senha e Senha de Confirmação não coincidem !!");
document.chngpwd.confirmpassword.focus();
return false;
}
return true;
...
<div class="controls">
<input type="password" placeholder="Digite Sua Nova Senha"  name="newpassword" class="span8 tip" required>
</div>
</div>

<div class="control-group">
<label class="control-label" for="basicinput">Confirme a Nova Senha</label>
<div class="controls">
