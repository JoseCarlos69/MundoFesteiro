...
if(isset($_POST['submit']))
{
	...
	$productQuantity = $_POST['productQuantity']; // Novo campo: Quantidade do Produto
...
if(!is_dir($dir)){
    ...
    if ($sql) {
        $productId = mysqli_insert_id($con); // Obtém o ID do produto inserido
        $quantity = $_POST['productQuantity'];
        $insertStockQuery = mysqli_query($con, "INSERT INTO inventory (product_id, available_quantity) VALUES ('$productId', '$quantity')");
        $_SESSION['msg'] = "Produto adicionados com sucesso!";
    }
...
{?>
									...
									<strong>Tudo certo!</strong>	<?php echo htmlentities($_SESSION['msg']);?><?php echo htmlentities($_SESSION['msg']="");?>
									</div>
<?php } ?>
...
{?>
									<div class="alert alert-error">
										<button type="button" class="close" data-dismiss="alert">×</button>
									<strong>Opa algo errado!</strong> 	<?php echo htmlentities($_SESSION['delmsg']);?><?php echo htmlentities($_SESSION['delmsg']="");?>
									</div>
<?php } ?>
...
<div class="controls">
<input type="text"    name="productCompany"  placeholder="Digite a Empresa do Produto" class="span8 tip" required>
</div>
</div>
<div class="control-group">
...
<div class="control-group">
<label class="control-label" for="basicinput">Preço do Produto Após o Desconto (Preço de Venda)</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Preço do Frete do Produto</label>
<div class="controls">
<input type="text"    name="productShippingcharge"  placeholder="Digite o preço do frete" class="span8 tip" required>
</div>
</div>

<div class="control-group">
<label class="control-label" for="basicinput">Estoque do Produto</label>
<div class="controls">
<input type="text"    name="productQuantity"  placeholder="Digite a quantidade em estoque" class="span8 tip" required>
</div>
</div>
...
<div class="control-group">
<label class="control-label" for="basicinput">1° Imagem do Produto</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">2° Imagem do Produto</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">3° Imagem do Produto</label>
<div class="controls">
