...
$_SESSION['msg']="Subcategoria Atualizada!";
...
<div class="controls">
<input type="text" placeholder="Digite o nome da Subcategoria"  name="subcategory" value="<?php echo  htmlentities($row['subcategory']);?>" class="span8 tip" required>
</div>
</div>
