...
$_SESSION['msg']="Imagem atualiazada!";
...
<div class="control-group">
<label class="control-label" for="basicinput">2° Imagem Atual</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">2° Imagem Nova</label>
<div class="controls">
