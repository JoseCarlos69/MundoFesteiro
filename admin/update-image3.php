...
$_SESSION['msg']="Imagem Atualizada!";
...
<div class="control-group">
<label class="control-label" for="basicinput">3° Imagem Atual</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">3° Imagem Nova</label>
<div class="controls">
