...
<?php } ?>
						...
						<ul class="widget widget-menu unstyled">
                                ...
                                <li><a href="subcategory.php"><i class="menu-icon icon-tasks"></i>Criar Sub-Categoria</a></li>
						...
						<ul class="widget widget-menu unstyled">
							<li><a href="user-logs.php"><i class="menu-icon icon-tasks"></i>Log de acesso dos Usuários</a></li>
