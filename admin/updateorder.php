...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr height="50">
      <td colspan="2" class="fontkink2" style="padding-left:0px;"><div class="fontpink2"> <b>Atualizar Pedido!</b></div></td>
...
$st='Em Entrega';
   ...
   <?php }else  {
    ...
    <tr>
      ...
      <input name="Submit2" type="submit" class="txtbox4" value="Fechar Janela " onClick="return f2();" style="cursor: pointer;"  /></td>
    </tr>
<?php } ?>
</table>
 </form>
